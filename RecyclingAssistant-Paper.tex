...
\bibitem{b1} “Tensorflow” Tensorflow, https://github.com/tensorflow/
...
\bibitem{b7} "React" Facebook, https://github.com/facebook/react
\end{thebibliography}~\\~\\
...
\begin{thebibliography}{00}
\bibitem{b0} "React" twbs, https://github.com/twbs/bootstrap
\bibitem{b1} "Docker Compose" Docker, https://github.com/docker/compose
\end{thebibliography}~\\~\\
